...
STU(symbol, button, soft, bord, T_D, etat_ecran), settings(symbol, button, soft, bord, T_D, etat_ecran)/*, srSpeed(fenetre, data), dataView(fenetre, data), systemVersion(fenetre, data)*/
{
	...
	"TC_36", "TC_37", "Sect", "BP", "SOS_DAAT", "SOS_INTG", "SOS_ZUB", "SOS_PZB", "SOS_VA", "SOS_TRI", "SOS_RS", "SOS_PSH", "LS_A_UL", "LS_AUTOR_DJ", "LS_DF_F", "LS_DF_F_FP", "LS_DF_TRA", "LS_I", "LS_PCO", "LS_QT_DJ", "LS_SI_AL", "EMPTY", "MAIS_MERDE" };
